        ...
        children: [
            ...
            child: Row(
              ...
              children: [
                ElevatedButton(
                  ...
                  child: const Text("تشفير باستخدام \n مفتاح عام", textAlign: TextAlign.center),
                ),
                ElevatedButton(
                  onPressed: () {
                    encryption(); //  ECC Function <<-------------------------->>
                  ...
                  child: const Text("تشفير باستخدام\n مفتاح خاص", textAlign: TextAlign.center),
                ),
              ],
            ),
          ),
          Padding(
            ...
            child: ElevatedButton(
              onPressed: () {
                if (cipherTextBankAccount == null || cipherTextamount == null) {
                  AwesomeDialog(
                    context: context,
